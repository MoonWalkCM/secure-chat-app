@echo off
echo ========================================
echo    Ngrok Tunnel для России - Запуск
echo ========================================
echo.
...
echo.
echo Ngrok URL появится в новом окне.
echo Обычно это: https://random-id.ngrok.io
echo.
echo Преимущества Ngrok:
echo - НЕ требует пароль
echo - Высокая скорость
echo - Полная поддержка WebSocket
echo - Стабильное соединение
echo.
echo ВНИМАНИЕ: Ngrok может быть заблокирован в России
echo Если не работает, используйте Serveo или VPS
echo.
echo Тестирование:
echo 1. Откройте Ngrok URL в браузере
