@echo off
echo ========================================
echo    Telebit Tunnel для России - Запуск
echo ========================================
echo.
...
echo.
echo Telebit URL появится в новом окне.
echo Обычно это: https://random-name.telebit.io
echo.
echo Преимущества Telebit:
...
echo.
echo Тестирование:
echo 1. Откройте Telebit URL в браузере
